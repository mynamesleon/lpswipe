...
(function ($) {
	$.fn.lpswipe = function (options) {
		...
		var defaults = {
			...
			start: function ($el) { }, // function that fires on first touch
			right: function (positionX, positionY, $el) { }, // swipe right function (move finger left to right)
			left: function (positionX, positionY, $el) { }, // swipe left function (move finger right to left)
			up: function (positionX, positionY, $el) { }, // swipe up function (move finger down to up)
			down: function (positionX, positionY, $el) { }, // swipe down function (move finger up to down)
			moving: function (positionX, positionY, $el) { }, // function for the whilst swiping
			notReached: function (positionX, positionY, $el) { }, // function to fire on touchend if the threshold isn't reached
			end: function (positionX, positionY, $el) { } // function that fires on touchend in all cases, after any directional functions (best used when swipeDirection is set to 'all')
		};
